...
concrete numbers from Step 1) and include the visual generated by Code Interpreter \
when the platform returns one. Do not invent external links, markdown image links, or \
